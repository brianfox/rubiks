/*
 * $Id: Cube.java,v 1.10 2010/08/23 23:12:48 bfox Exp $
 * @Copyright@
 * @Copyright@ 
 * 
 * $Log: Cube.java,v $
 * Revision 1.10  2010/08/23 23:12:48  bfox
 ...
 *
 * Revision 1.8  2010/04/02 17:09:51  bfox
 * Don't really care for the idea of set and reset.  Might rethink it.
 *
 * Revision 1.7  2010/03/29 17:30:17  bfox
 ...
 *
 * Revision 1.6  2010/03/20 17:31:56  bfox
 * Added the idea of an axis, rubik's cube edge, and offset from the origin.
 *
 * Revision 1.5  2010/03/03 17:29:24  bfox
 * Developed an unfolded cube drawing.
 * Added it to the graph.
 *
 * Revision 1.4  2010/02/28 20:01:38  bfox
 * Rearranged methods, grouped by function.
 *
 ...
 * Rearranged packages.
 *
 * Revision 1.46  2009/07/13 15:21:38  bfox
 * *** empty log message ***
 *
 * Revision 1.45  2009/06/16 20:15:56  bfox
 * *** empty log message ***
 *
 * Revision 1.42  2009/06/08 16:26:49  bfox
 * *** empty log message ***
 *
 * Revision 1.41  2009/06/02 22:46:21  bfox
 ...
 *
 * Revision 1.40  2009/05/15 20:20:00  bfox
 * Modified Cube to be stateless.  State is now carried in other classes.
 *
 * Revision 1.39  2009/05/07 18:49:14  bfox
 * *** empty log message ***
 *
 * Revision 1.38  2009/05/06 17:19:26  bfox
 * *** empty log message ***
 *
 *
 */
...
import fox.brian.util.ArrayUtil;
import fox.brian.util.StringUtil;
